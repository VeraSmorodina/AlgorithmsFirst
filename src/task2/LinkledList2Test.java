...
//
//    @Test
//    public void findAllInManyElementsListTest4() {
//        LinkedList2 list = new LinkedList2();
//        list.addInTail(new Node(10));
//        list.addInTail(new Node(20));
//        list.addInTail(new Node(20));
...
//
//    @Test
//    public void findAllInOneElementListTest2() {
//        LinkedList2 list = new LinkedList2();
//        list.addInTail(new Node(10));
...
//
//    @Test
//    public void findAllInOneElementListWithoutElementTest3() {
//        LinkedList2 list = new LinkedList2();
//        list.addInTail(new Node(10));
